...
| GitHub | 15 | Professional README, structure, pinned environment, code-scoped MIT license, ignored data/models, CI test workflow, AI disclosure with code examples, and demo transcript | `../README.md`; `../requirements-lock.txt`; `../.gitignore`; `../.github/workflows/tests.yml`; `Generative_AI_Usage.md`; `../demo/` | Addressed in live repository |
